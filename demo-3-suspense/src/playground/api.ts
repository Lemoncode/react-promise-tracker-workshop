...
const actorURL = (id: number) =>
  `${process.env.BASE_API_URL}/api/actors/${id}`;
...
export const getActor = (id: number, delay = 1000): Promise<Actor> =>
  fetchWithDelay(actorURL(id), delay);
